            ...
            >
                ...
                >
                    ...
                    <div className="flex justify-between gap-6">
                        <button
                            type="submit"
                            className="bg-tertiary py-4 px-10 rounded-lg text-white text-sm font-medium shadow-sm hover:shadow-md transition"
                        >
                            {loading ? "Envoi..." : "Envoyer"}
                        </button>

                        <a
                            href="/CV_Yasser_SANHAJI.pdf"
                            download="CV_Yasser_SANHAJI.pdf"
                            className="bg-secondary py-4 px-10 rounded-lg text-white text-sm font-medium shadow-sm hover:shadow-md transition"
                        >
                            Mon CV
                        </a>
                    </div>
