        ...
        >
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              <button
                  type="submit"
                  className="bg-tertiary py-2 px-4 rounded-lg text-white text-sm font-medium shadow-sm hover:shadow-md transition"
              >
                {loading ? "Envoi..." : "Envoyer"}
              </button>

              <a
                  href="/Cv Yasser SANHAJI.pdf"
                  download="Cv Yasser SANHAJI.pdf"
                  className="bg-secondary py-2 px-4 rounded-lg text-white text-sm font-medium shadow-sm hover:shadow-md transition"
              >
                 Mon CV
              </a>

              <a
                  href="/tableau_de_synthese.pdf"
                  download="tableau_de_synthese.pdf"
                  className="bg-indigo-500 py-2 px-4 rounded-lg text-white text-sm font-medium shadow-sm hover:shadow-md transition"
              >
