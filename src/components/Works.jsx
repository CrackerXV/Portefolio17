    ...
    return (
        <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
            <Tilt
                ...
                className='bg-tertiary p-5 rounded-2xl w-full sm:w-[360px] h-[480px] flex flex-col justify-between'
            >
        ...
        <div className="px-4 sm:px-0">
            ...
            <div className='w-full flex flex-col'>
                <motion.p
                    ...
                    className='mt-3 text-secondary text-[16px] sm:text-[17px] leading-[26px] sm:leading-[30px]'
                >
                    ...
                    liens vers les dépôts de code et des démonstrations en ligne. Ils reflètent ma capacité
                    à résoudre des problèmes complexes, à utiliser différentes technologies et à gérer
